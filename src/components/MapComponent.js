    ...
    const changeTramManyObject = (type,id,maTram)=>{
        if(type==='Tru'){
            fetch(URLAPI4001+'/Api/SangTaiChuyenLuoi/changeTramPoint?id='+id+'&maTram='+maTram, {
                ...
                .then(response => {
                    if (response.status === 200) {
                        ...
                        showNotification('Thông báo!', 'Đã chuyển trạm đối tượng ' + id + ' sang trạm '+maTram+' thành công ', 1000, 400);
            ...
            fetch(URLAPI4001+'/Api/SangTaiChuyenLuoi/changeTramLine?id='+id+'&maTram='+maTram, {
                ...
                .then(response => {
                    if (response.status === 200) {
                        showNotification('Thông báo!', 'Đã chuyển dây ' + id + ' sang trạm '+maTram+' thành công ', 1000, 400);
        ...
        return (
            ...
            >
                ...
                <GoogleMap
                    ...
                    onClick={(e) => {
                        ...
                        if (optionEffectObject.value === "AddTru") {
                            const tmp = window.prompt('Xin hãy nhập tên trụ!');
                            ...
                            let tmp = window.prompt('Nhập tên trạm');
                            if (tmp !== null) {
                                fetch(URLAPI+'/APIKTGS/Drawing/savePoint', {
                                    ...
                                    .then(response => {
                                        ...
                                        if (response.status ===200) {
                                            ...
                                            showNotification('Thông báo!', 'Đã thêm trạm ' + tmp + ' thành công!', 2000, 400);
                                ...
                                alert('Không có thông tin thể thêm trạm');
                            }
                            ...
                            if (props.typeTruAdd === 'TruTH') {
                                ...
                                if (tmp !== null) {
                                    fetch(URLAPI+'/APIKTGS/Drawing/savePoint', {
                                        ...
                                        .then(response => {
                                            if (response.status ===200) {
                                                ...
                                                showNotification('Thông báo!', 'Đã thêm tủ diện ' + tmp + ' thành công!', 2000, 400);
                                    ...
                                    alert('Không có thông tin tủ điện')
                                }
                            }
                            ...
                            if (props.typeTruAdd === 'TruTH') {
                                ...
                                if (tmp !== null) {
                                    ...
                                    alert('Không có thông tin để thêm tủ');
                                }
                            }
                        }
                    }}
                ...
                >
                                ...
                                if (item.mA_DDO === null || item.mA_DDO === '') {
                                    if (item.typE_E === 'DDIEN_KH') {
                                        ...
                                        return <Polyline
                                            ...
                                            options={{
                                                label: { color: 'red', text: 'Thanh Bình', fontWeight: 'bold', fontSize: "12px" },
                    ...
                    {/* Vẽ khách hàng sau khi tìm kiếm */}
                    ...
                    {(objectSelected.type === 'KhachHang' && optionEffectObject.value === null && objectSelected.object.toA_DO !== null) ?
                        ...
                        >
                            <InfoKhachHangComponent maTramSelected={props.maTramSelected} tenTramSelected={props.tenTramSelected} item={objectSelected.object} soTru={listTru === null ? 'Không có' : listTru.find(i => {
                    ...
                    {/* Tao window info cho khách hàng Search */}
                    ...
                    {(objectSelected.type === 'Tru' && optionEffectObject.value === null && objectSelected.object !== null) ?
                        ...
                        >
                            <div>
                                ...
                                <h4>Mã Trạm: {objectSelected.object.mA_TRAM}</h4>
                                <h6>Tên Trụ: {objectSelected.object.namE_E}</h6>
                                <h6>Tọa độ: (lng: '{objectSelected.object.longitude}',lat:'{objectSelected.object.latitude}')</h6>
                                <h6>Danh sách khách hàng: {objectSelected.object.dS_DIEMDO===null || objectSelected.object.dS_DIEMDO.length === 0 ? '' : objectSelected.object.dS_DIEMDO.toString()}</h6>
                            </div>
                        </InfoWindow>
                        :
                        null
